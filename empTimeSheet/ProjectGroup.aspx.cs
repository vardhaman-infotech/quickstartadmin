...
namespace empTimeSheet
{
    public partial class ProjectGroup : System.Web.UI.Page
    {
        ...
        protected void fillpopproject()
        {
            ...
            listcode1.DataTextField = "projectcodename";
            listcode1.DataValueField = "nid";
            listcode1.DataBind();


            int count = listcode1.Items.Count;
            string[] clientval = hidgroupprojects.Value.Split(',');
            string[] clientname = hidgroupprojectname.Value.Split(',');
        ...
        /// <summary>
        /// Fill list of existing projects For Search
        /// </summary>
        ...
        protected void searchdata()
        {
            ...
            hidsearchclientid.Value = dropproject.Text;
            hidsearchclientname.Value = dropproject.SelectedItem.Text;
            fillgrid();
        }
        ...
        /// </summary>
        protected void fillprojectgroup()
        {
            //fillprojectgroup();
            ds = getdetails();
            if (ds.Tables[0].Rows.Count > 0)
            ...
            if (ds.Tables[1].Rows.Count > 0)
            {
                listcode2.DataTextField = "projectcodewithname";
                listcode2.DataValueField = "projectid";
                listcode2.DataSource = ds.Tables[1];
                listcode2.DataBind();
                int count = listcode1.Items.Count;
                for (int j = 0; j < ds.Tables[1].Rows.Count; j++)
                {
                    hidgroupprojects.Value = hidgroupprojects.Value + ds.Tables[1].Rows[j]["projectid"].ToString() + ",";
                    hidgroupprojectname.Value = hidgroupprojectname.Value + ds.Tables[1].Rows[j]["projectcodewithname"].ToString() + ",";
                }
                for (int i = 0; i < count; i++)
                {
                    for (int j = 0; j < ds.Tables[1].Rows.Count; j++)
                    {
                        //Remove the expenses from Listcode1 those are already exists in group
                        if (listcode1.Items[i].Value == ds.Tables[1].Rows[j]["projectid"].ToString())
                        {
                            listcode1.Items.RemoveAt(i);
                            count = listcode1.Items.Count;
                            i = i - 1;
        ...
        protected void btnsubmit_Click(object sender, EventArgs e)
        {
            ...
            objuser.clientname = hidgroupprojects.Value;
        ...
        {
            hidgroupprojects.Value = "";
            hidgroupprojectname.Value = "";
            txtgroup.Text = "";
            hidid.Value = "";
        ...
        protected void btnexportcsv_Click(object sender, EventArgs e)
        {
            ...
            if (hidcurrentview.Value == "detail")
            {
                ...
                {
                    rpthtml = rpthtml + "<tr><td>" + Convert.ToString(i + 1) + "</td>" + "<td>" + dsexcel.Tables[1].Rows[i]["projectCode"].ToString() +
                        "</td><td>" + dsexcel.Tables[1].Rows[i]["projectname"].ToString() +
            ...
            else
            {
                ...
                for (int i = 0; i < dsexcel.Tables[0].Rows.Count; i++)
                {
                    rpthtml = rpthtml + "<tr><td>" + Convert.ToString(i + 1) + "</td>" + "<td>" + dsexcel.Tables[0].Rows[i]["grouptitle"].ToString() +
                        "</td><td>" + dsexcel.Tables[0].Rows[i]["numofprojects"].ToString() +
            ...
            response.AddHeader("Content-Disposition", "attachment;filename=\"HCLLPProjectGroup-Report.xls\"");
        ...
        protected string bindlistviewheader(string type)
        {
            ...
            string str = "";
            string project = "<b>Project:</b> ", Keyword = "<b>Keyword:</b>";
            ...
            {
                project += hidsearchclientname.Value;
            }
