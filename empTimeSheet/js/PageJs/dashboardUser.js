var pagename = "UserDashboard.aspx";
...
function fillchart(reportid, loaderid, chartdivid, clorscheme) {
...
function fillTaskStatus() {
    ...
    document.getElementById("loaderTask").style.display = "block";
        ...
        success: function (msg) {
            if (msg.d != "failure") {
                ...
                if (jsonarr.length > 0) {
                    ...
                    for (var i in jsonarr) {
                        document.getElementById("strbilled").innerHTML = jsonarr[i].totalinprocesstasks;
                        document.getElementById("strtotal").innerHTML = jsonarr[i].totalassignedtasks;
                        document.getElementById("strunbilled").innerHTML = jsonarr[i].totalcompletedtasks;
                ...
                document.getElementById("loaderTask").style.display = "none";
                // setup the chart
...
$(document).ready(function () {
    fillchart("Top Ten Activities", "loadertopact", "charttopact", 'scheme04');
    fillmonthlychar();
    fillTaskStatus();
