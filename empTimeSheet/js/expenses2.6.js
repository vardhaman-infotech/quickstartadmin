...
function bindprojectautocompleter(inputid, hiddenid) {
    ...
    $("#" + inputid + "").autocomplete({
        ...
        select: function (event, ui) {
            ...
            bindprojectvalue(hiddenid, ui.item == null ? "" : ui.item.value2);
...
function addrow() {
    ...
    // celldelete.oncontextmenu = function (e) { alert(newsno); };

    celldelete.innerHTML = "<div class='rightclickcopy' id='divcopy" + newsno + "'><a onclick='copyrecord();'>Copy</a></div><div id='divdel" + newsno + "' ><a style='cursor: pointer;color:bule;' id='delete' onclick='deleterow(this,this.id);' ><img src='images/delete.png' /></a></div>";
    ...
    cellproject.innerHTML = "<input type='text' id='ddlproject" + newsno + "' class='form-control' onkeypress='settab(this.id,event);'  /> <input type='hidden' id='hidproject" + newsno + "' /> <input type='hidden' id='hidbillable" + newsno + "'  /><input type='hidden' id='hiememorequire" + newsno + "'  /><input type='hidden' id='hidistaskreadonly" + newsno + "'  />";
    ...
    cellmu.innerHTML = "<input type='text' id='txtmu" + newsno + "' class='form-control' onkeypress='blockNonNumbers(this, event, true, false);settab(this.id,event);addautorow(" + newsno + ",event);'  onkeydown='addautorow(" + newsno + ",event);'  onblur='extractNumber(this,2,true);calcamount(this.id);' onkeyup='checkless(this);extractNumber(this,2,true);extractNumber(this,2,true);calcamount(this.id);' />";
    ...
    celldes.innerHTML = "<input type='text' id='txtdesc" + newsno + "' class='form-control' maxlength='150'   onblur='removeSpecialCh(this.id,event)'   />";
...
function calhours() {
    ...
    for (var i = 0; i <= id; i++) {
        newid = "txtamount" + i;
        //  alert(newid); if (document.getElementById(newid1) != null) {
        if (document.getElementById(newid) != null && document.getElementById(newid).value != "" && !isNaN(document.getElementById(newid).value)) {
...
function savedata() {
    ...
    for (var i = 0; i <= id; i++) {
        ...
        newid = "ddlproject" + i;
        newid1 = "hidproject" + i;
        if (document.getElementById(newid1) != null) {
            ...
            if (document.getElementById(newid).value == "Yes") {
                ...
                if (document.getElementById(newid).value.trim() == "") {
