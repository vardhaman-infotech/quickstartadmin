...
function addrow() {
   ...
   // var celldate = row.insertCell(colnum); colnum++;
    ...
    //celldate.innerHTML =
        +"<input type='text' style='display:none;' id='txtdate" + newsno + "' onkeypress='setdtab(" + newsno + ",event);' class='form-control date'  onchange='checkdate(this.value,this.id);'/>";
    ...
    celldes.innerHTML = "<input type='text' id='txtdesc" + newsno + "' readonly class='form-control' maxlength='150' onkeydown='addautorow(" + newsno + ",event);' onkeypress='addautorow(" + newsno + ",event);' onblur='removeSpecialCh(this.id,event)'   />";
            ...
            if (data.d != "") {
                ...
                $.each(jsonObj, function (i, item) {
                    ...
                    if (i == 0) {
                        ...
                        document.getElementById("favhidid_0").value = item.nid;
                        ...
                        document.getElementById("hidmemo0").innerHTML = item.memo;
