<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="comp_ScheduleEmail.aspx.cs" Inherits="empTimeSheet.comp_ScheduleEmail" %>
...
<head runat="server">
    <title>Schedule Email Settings</title>
                ...
                <div class="maindiv">
                    ...
                    <div class="ctrlGroup searchgroup">
                        <label class="lbl lblAuto">
                            Select Receivers for Scheduling Emails :
                        </label>
