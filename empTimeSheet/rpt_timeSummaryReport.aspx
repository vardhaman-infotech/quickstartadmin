<%@ Page Title="" Language="C#" MasterPageFile="~/userMaster.Master" AutoEventWireup="true" CodeBehind="rpt_timeSummaryReport.aspx.cs" Inherits="empTimeSheet.rpt_timeSummaryReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="pageheader">
        <h2>
            <i class="fa fa-clipboard"></i>Time Summary by Project, Employee & Task
        </h2>
                    ...
                    <div class="col-sm-12 col-md-10">
                        <div style="padding-top: 10px;">
                            <div class="col-xs-12 col-sm-8 col-md-6 f_left" style="padding: 0px;">
                                <h5 class="subtitle mb5">Time Summary by Project, Employee & Task</h5>
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4  pad4">
                                ...
                                <asp:Panel ID="panelemployee" runat="server" CssClass="poppanel">
                                    ...
                                    <asp:CheckBoxList ID="dropemployee" runat="server" RepeatLayout="Flow" RepeatDirection="Horizontal" ClientIDMode="Static" onchange="setcontent(this.id,'txtemployee','--All Employee--','employee');"></asp:CheckBoxList>
                            ...
                            <div class="col-sm-6 col-md-4  pad5">
                                <asp:TextBox ID="txtclient" runat="server" CssClass="form-control mar pad3" ClientIDMode="Static" placeholder="--All Clients--">
                                </asp:TextBox>
                                ...
                                <asp:Panel ID="panelclient" runat="server" CssClass="poppanel">
                                    ...
                                    <span>Check All</span><div class="clear"></div>
                                    <asp:CheckBoxList ID="dropclient" runat="server" RepeatLayout="Flow" ClientIDMode="Static" onchange="setcontent(this.id,'txtclient','--All Clients--','client');"></asp:CheckBoxList>
                            ...
                            <div class="col-sm-6 col-md-4  pad4">
                                ...
                                <asp:Panel ID="pnlproject" runat="server" CssClass="poppanel">
                                    ...
                                    <span>Check All</span><div class="clear"></div>
                                    <asp:CheckBoxList ID="dropproject" runat="server" RepeatLayout="Flow" RepeatDirection="Horizontal" RepeatColumns="1" ClientIDMode="Static" onchange="setcontent(this.id,'txtproject','--All Projects--','project');"></asp:CheckBoxList>
