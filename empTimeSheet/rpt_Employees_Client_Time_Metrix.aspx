<%@ Page Title="" Language="C#" MasterPageFile="~/userMaster.Master" AutoEventWireup="true" CodeBehind="rpt_Employees_Client_Time_Metrix.aspx.cs" Inherits="empTimeSheet.rpt_Employees_Client_Time_Metrix" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="pageheader">
        <h2>
            <i class="fa fa-clipboard"></i>Employee-Client-Time Report
        </h2>
                        ...
                        <div style="padding-top: 10px;">
                            <div class="col-xs-12 col-sm-8 col-md-6 f_left" style="padding: 0px;">
                                <h5 class="subtitle mb5">
                                    <asp:Label ID="lblReportName" runat="server" Text="Employee-Client-Time"></asp:Label>
                                </h5>
                            </div>
                            <div class="clear"></div>
                            <div class="ctrlGroup">
                        ...
                        <asp:UpdatePanel ID="upadatepanel" runat="server" UpdateMode="Conditional" >
                            <ContentTemplate>
                                ...
                                <div id="divreport" runat="server" class="mainrptdiv" visible="false">
                                    ...
                                    <rsweb:ReportViewer ID="ReportViewer2" runat="server" Width="100%" Height="600px">
                                    </rsweb:ReportViewer>
