<%@ Page Title="" Language="C#" MasterPageFile="~/userMaster.Master" AutoEventWireup="true" CodeBehind="rpt_AssetByDepartment.aspx.cs" Inherits="empTimeSheet.rpt_AssetByDepartment" %>
                                ...
                                <div style="padding-top: 10px;">
                                    <div class="col-xs-12 col-sm-8 col-md-6 f_left" style="padding: 0px;">
                                        <h5 class="subtitle mb5">
                                            <asp:Label ID="lblReportName" runat="server" Text="Asset Reprot by Department"></asp:Label>
                                        </h5>
                                    </div>
                                    <div class="clear"></div>
                                    <div class="ctrlGroup searchgroup">
                                        <label class="lbl lbl1">Assets :</label>
                                    ...
                                    <div class="clear"></div>
                                    <div class="ctrlGroup searchgroup">
                                        <label class="lbl lbl1">Category :</label>
                                        <div class="txt w1 mar10">
                                        <asp:TextBox ID="txtCategory" runat="server" CssClass="form-control" ClientIDMode="Static" placeholder="--All Category--" onkeypress="searchfilters(this.id,'dropCategory');" onkeyup="searchfilters(this.id,'dropCategory');" onkeydown="searchfilters(this.id,'dropCategory');">
                                        </asp:TextBox>
