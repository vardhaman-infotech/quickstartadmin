...
{
    public partial class ServerBackUpReport : System.Web.UI.Page
    {
        ...
        /// <summary>
        /// Fill client drop down for searching
        /// </summary>
        ...
        /// <summary>
        /// fill server drop down for searching
        /// </summary>
        ...
        {
            objserver.action = "getserverbackupreport";
            objserver.nid = "";
            objserver.clientid = dropclient.Text;
        ...
        protected void btnexportcsv_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dsexcel.Tables[0].Rows.Count; i++)
            {
                rpthtml = rpthtml + "<tr><td>" + dsexcel.Tables[0].Rows[i]["Clientname"].ToString() +
                   ...
                   "<td>" + dsexcel.Tables[0].Rows[i]["date"].ToString() + "</td>" + "<td>" + dsexcel.Tables[0].Rows[i]["BackupDescription"].ToString() + "</td></tr>";
            }
            ...
            response.AddHeader("Content-Disposition", "attachment;filename=\"ServerBackUpReport.xls\"");
