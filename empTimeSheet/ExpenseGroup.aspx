<%@ Page Title="" Language="C#" MasterPageFile="~/userMaster.Master" AutoEventWireup="true"
    CodeBehind="ExpenseGroup.aspx.cs" Inherits="empTimeSheet.ExpenseGroup" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function move(btnaddmember, btnremove) {
            ...
            document.getElementById('ctl00_ContentPlaceHolder1_hidclients').value = strval;
            document.getElementById('ctl00_ContentPlaceHolder1_hidclientname').value = strname;
            searchclient();
            sortlist();
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="pageheader">
        <h2>
            <i class="fa fa-tasks"></i>Expense Groups
        </h2>
        <div class="breadcrumb-wrapper mar ">
            <a id="liaddnew" runat="server" class="right_link" onclick="opendiv();">
       <i class="fa fa-fw fa-plus topicon"></i> Add New Group</a>
                            ...
                            <div class="col-sm-12 col-md-10">
                                <div style="padding-top: 10px;">
                                    ...
                                    <div class="ctrlGroup searchgroup">
                                        ...
                                        <asp:TextBox ID="txtsearch" runat="server" CssClass="form-control" placeholder="Search group title.."></asp:TextBox>
                                            </div>
                                    </div>
                                    <div class="ctrlGroup searchgroup">
                                        <label class="lbl">Expense : </label>
                                        <div class="txt w2 mar10">
                                        <asp:DropDownList ID="dropExpense" runat="server" CssClass="form-control">
                                        </asp:DropDownList>
                                    </div></div>
                                    <div class="ctrlGroup searchgroup">
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <asp:GridView ID="dgnews" runat="server" AllowPaging="true" AutoGenerateColumns="False"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="No. of Expense" SortExpression="numofexpenses">
                                                            <ItemTemplate>
                                                                <%#DataBinder.Eval(Container.DataItem, "numofexpenses")%>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                            ...
                            <div class="col-sm-12 col-md-10">
                                <div style="padding-top: 10px;">
                                    <div class="col-xs-12 col-sm-8 col-md-6 f_left" style="padding: 0px;">
                                        <h3 class="mb5" id="ltrgrouptitle" runat="server">
                                        </h3>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="col-xs-12 clear">
                                            <div class="col-xs-12 col-sm-6 f_left pad">
                                                <label class="col-xs-12 control-label pad" style="margin-left: -10px;">
                                                    Created By:
                                                    <asp:Literal ID="ltrcreatedby" runat="server"></asp:Literal></label></div>
                                            <div class="pad f_right">
                                                <label class="col-xs-12 control-label pad">
                                                    Creation Date:
                                                    <asp:Literal ID="ltrcreationdate" runat="server"></asp:Literal></label></div>
                                            <div class="clear">
                                            </div>
                                            <div class="nodatafound" id="divnodataforstatus" runat="server">
                                                Expense not found</div>
                                            <div class="panel">
                                                <div class="row">
                                                    <div class="table-responsive">
    ...
    <div style="display: none; width: 680px;" id="divaddnew" class="itempopup">
        ...
        <div class="tabContents">
            <div class="col-xs-12 col-sm-12">
                <div class="ctrlGroup searchgroup">
                    <label class="lbl">Group Title :<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtgroup"
                ...
                <div class="ctrlGroup searchgroup">
                    <label class="lbl">Select Expense :<asp:CustomValidator ID="CustomValidator1" runat="server" ErrorMessage="*" ValidationGroup="save"
                            CssClass="errmsg" ClientValidationFunction="validate1"></asp:CustomValidator></label>
                    <div class="txt w3" style="margin-bottom: 20px;">
                        <asp:TextBox ID="txtsearchclient" runat="server" placeholder="Search Expense by keyword"
            ...
            <div class="col-xs-12 col-sm-12">
                <div class="col-xs-12 col-sm-6 f_left pad">
                    <label class="col-xs-12 control-label">
                        <b>Group Title:
                            <asp:Literal ID="ltravailtogrouptitle" runat="server"></asp:Literal></b></label></div>
                <div class="col-xs-12 col-sm-6 clear f_left pad">
                    <label class="col-xs-12 control-label">
                        <b>Created By:
                            <asp:Literal ID="ltravailtocreatedby" runat="server"></asp:Literal></b></label></div>
                <div class="pad f_right">
                    <label class="col-xs-12 control-label">
                        <b>Creation Date:
                            <asp:Literal ID="ltravailtocreationdate" runat="server"></asp:Literal></b></label></div>
                <div class="clear">
                </div>
                ...
                <div class="col-xs-12 form-group pad">
                    <div class="f_left">
                        <asp:ListBox ID="listavailcode1" runat="server" Width="260px" Height="200px" SelectionMode="Multiple">
                        </asp:ListBox>
                    ...
                    <div class="f_left">
                        <asp:ListBox ID="listavailcode2" runat="server" Width="260px" Height="200px" SelectionMode="Multiple">
                        </asp:ListBox>
                    </div>
                </div>
                <div class="clear">
