<%@ Page Title="" Language="C#" MasterPageFile="~/userMaster.Master" AutoEventWireup="true" CodeBehind="TimeExpenseReport.aspx.cs" Inherits="empTimeSheet.TimeExpenseReport" %>
    ...
    <asp:UpdatePanel ID="upadatepanel" runat="server">
        <ContentTemplate>
            ...
            <div class="pageheader">
                <h2>
                    <i class="fa fa-table"></i>Time & Expense Report by Project & Employee
                </h2>
                            ...
                            <div class="col-sm-12 col-md-10">
                                <div style="padding-top: 10px;">
                                    <div class="col-xs-12 col-sm-8 col-md-6 f_left" style="padding: 0px;">
                                        <h5 class="subtitle mb5">Time & Expense Report by Project & Employee</h5>
                                    </div>
                                                ...
                                                <div id="divreport" runat="server" class="mainrptdiv">
                                                    ...
                                                    <asp:Repeater ID="rptclients" runat="server" OnItemDataBound="rptclients_ItemDataBound">
                                                                            ...
                                                                            <td style="border-top: 2px solid #959595; border-bottom: 2px solid #959595; margin: 8px 0;">
                                                                                <table class="table" width="100%" cellpadding="4">
                                                                                    <tr bgcolor="#f2f2f2">
                                                                                        ...
                                                                                        <th width="10%" style="text-align: right; font-weight: bold; color: #333333; font-size: 10pt; font-family: calibri; padding: 6px; vertical-align: top;">Cost</th>
                                                        ...
                                                        <FooterTemplate>
                                                            ...
                                                            <tr>
                                                                <td align="right" style="width: 100%; margin-top: 15px; text-align: right;color: #cccccc; font-size: 10pt; font-weight: bold;">
                                                                    *
                                                                       
                                                                      <img border="0" alt="" src="http://scheduler.harshwal.com//images/nonbillable.png" style="border: 0 none; margin-right: 5px;">
                                                                    = Non-Billable
