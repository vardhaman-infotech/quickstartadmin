...
{
    public partial class rpt_budgetSummary : System.Web.UI.Page
    {
        ...
        private void f_ReportLoad()
        {
            try
            {
                ...
                ReportViewer1.LocalReport.ReportPath = p + "\\Budget\\BudgetSummary.rdlc";
                ...
                ReportViewer1.LocalReport.DisplayName = "Budget Summary Report";
            }
            catch (Exception ex)
            {
            }
