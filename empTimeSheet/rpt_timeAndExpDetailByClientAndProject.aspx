<%@ Page Title="" Language="C#" MasterPageFile="~/userMaster.Master" AutoEventWireup="true" CodeBehind="rpt_timeAndExpDetailByClientAndProject.aspx.cs" Inherits="empTimeSheet.rpt_timeAndExpDetailByClientAndProject" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="pageheader">
        <h2>
            ...
            <asp:Literal ID="reportname1" runat="server" Text="Client Report"></asp:Literal>
        </h2>
                        ...
                        <div style="padding-top: 10px;">
                            <div class="col-xs-12 col-sm-8 col-md-8 f_left" style="padding: 0px;">
                                <h5 class="subtitle mb5">
                                    <asp:Literal ID="reportname" runat="server" Text="Time & Expense Report by Client, Project & Employee"></asp:Literal></h5>
                            </div>
                            ...
                            <div class="divsearch">
                                ...
                                <asp:UpdatePanel ID="updatepanelButton" UpdateMode="Conditional" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <div class="divsearch" style="margin: 5px 0 0 5px">
                                        ...
                                        <div class="row">
                                            <div class="table-responsive">
                                                ...
                                                <div id="divreport" runat="server" class="mainrptdiv" visible="false">
                                                    ...
                                                    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" Height="600px" ShowRefreshButton="false">
                                                    </rsweb:ReportViewer>
                                                </div>
                                            </div>
                                        </div>
