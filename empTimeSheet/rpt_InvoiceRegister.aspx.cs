...
{
    public partial class rpt_InvoiceRegister : System.Web.UI.Page
    {
        ...
        private void f_ReportLoad()
        {
            try
            {
                ...
                ReportViewer1.LocalReport.ReportPath = p + "\\billing\\invoicelistrdlc.rdlc";
                ...
                ReportViewer1.LocalReport.DisplayName = "Invoice Register";
            }
            catch (Exception ex)
            {
            }
