<%@ Page Title="" Language="C#" MasterPageFile="~/userMaster.Master" AutoEventWireup="true" CodeBehind="rpt_AssetByLocation.aspx.cs" Inherits="empTimeSheet.rpt_AssetByLocation" %>
                        ...
                        <div class="panel panel-default">
                                ...
                                <div style="padding-top: 10px;">
                                    <div class="col-xs-12 col-sm-8 col-md-6 f_left" style="padding: 0px;">
                                        <h5 class="subtitle mb5">
                                            <asp:Label ID="lblReportName" runat="server" Text="Asset By Location Report"></asp:Label>
                                        </h5>
                                    </div>
                                    <div class="clear"></div>
                                    <div class="divsearch">
                                        ...
                                        <asp:TextBox ID="txtAsset" runat="server" CssClass="form-control mar pad3" ClientIDMode="Static" placeholder="--All Assets--" onkeypress="searchfilters(this.id,'dropAsset');" onkeyup="searchfilters(this.id,'dropAsset');" onkeydown="searchfilters(this.id,'dropAsset');">
                                        </asp:TextBox>
                                    ...
                                    <div class="divsearch">
                                        ...
                                        <asp:TextBox ID="txtDepartment" runat="server" CssClass="form-control mar pad3" ClientIDMode="Static" placeholder="--All Department--" onkeypress="searchfilters(this.id,'dropDepartment');" onkeyup="searchfilters(this.id,'dropDepartment');" onkeydown="searchfilters(this.id,'dropDepartment');">
                                        </asp:TextBox>
                                    ...
                                    <div class="divsearch">
                                        ...
                                        <asp:TextBox ID="txtCategory" runat="server" CssClass="form-control mar pad3" ClientIDMode="Static" placeholder="--All Category--" onkeypress="searchfilters(this.id,'dropCategory');" onkeyup="searchfilters(this.id,'dropCategory');" onkeydown="searchfilters(this.id,'dropCategory');">
                                        </asp:TextBox>
                            ...
                            <div class="col-sm-12 col-md-12 mar2">
                                ...
                                <div id="divreport" runat="server" class="mainrptdiv">
                                    ...
                                    <rsweb:ReportViewer ID="ReportViewer1" runat="server" AsyncRendering="false" align="center" SizeToReportContent="true" PromptAreaCollapsed="true" Width="100%" Height="600px">
                                    </rsweb:ReportViewer>
                                </div>
                                <div class="clear"></div>
