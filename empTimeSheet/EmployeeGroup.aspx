<%@ Page Title="" Language="C#" MasterPageFile="~/userMaster.Master" AutoEventWireup="true"
    CodeBehind="EmployeeGroup.aspx.cs" Inherits="empTimeSheet.EmployeeGroup" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <!---Scripts to move Available to  Code GOES here-->
    <script type="text/javascript">
        ...
        function move1(btnaddmember, btnremove) {
            ...
            document.getElementById('ctl00_ContentPlaceHolder1_hidavailid').value = strval;
            document.getElementById('ctl00_ContentPlaceHolder1_hidavailname').value = strname;
            searchavailableto();
            sortlist1();
        }
    ...
    <!--END- scripts to move Available to Code-->
    <script type="text/javascript">
        function opendiv() {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="pageheader">
        <h2>
            <i class="fa  fa-group"></i>Employee Groups
        </h2>
    ...
    <div class="contentpanel">
        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-12 mar2">
                                <div class="col-sm-12 col-md-9 pad">
                                    ...
                                    <div class="ctrlGroup searchgroup">
                                        <label class="lblAuto">Group Title : </label>
                                        <div class="txt w1 mar10">
                                            <asp:TextBox ID="txtsearch" runat="server" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="ctrlGroup searchgroup">
                                        <label class="lblAuto">Employees : </label>
                                        <div class="txt w1 mar10">
                                ...
                                <div class="ctrlGroup" style="float:right;">
            ...
            <i class="fa fa-fw fa-fast-backward color_green"></i></asp:LinkButton>
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <asp:GridView ID="dgnews" runat="server" AllowPaging="true" AutoGenerateColumns="False"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="No. of Employees" SortExpression="numofemployees">
                                                            <ItemTemplate>
                                                                <%#DataBinder.Eval(Container.DataItem, "numofemployees")%>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                ...
                                <input type="hidden" id="hidsearchempid" runat="server" />
                                <input type="hidden" id="hidsearchempname" runat="server" />
                            </div>
                            <div class="clear">
                            </div>
                        </asp:View>
    ...
    <div style="display: none; width: 680px;" id="divaddnew" class="itempopup">
        ...
        <div class="tabContents">
            <div class="col-xs-12 col-sm-12">
                ...
                <div class="ctrlGroup searchgroup">
                    <label class="lbl">
                        Select Employees<asp:CustomValidator ID="CustomValidator1" runat="server" ErrorMessage="*" ValidationGroup="save"
                    ...
                    <div class="txt w3">
                        <asp:TextBox ID="txtsearchname" runat="server" placeholder="Search Employees by keyword"
                            onkeyup="searchname();" CssClass="form-control pad3"></asp:TextBox>
                    </div>
                </div>
        ...
        <div class="tabContents">
            <div class="col-xs-12 col-sm-12">
                ...
                <div class="col-xs-12 form-group f_left pad">
                    ...
                    <div class="col-xs-10">
                        <asp:TextBox ID="txtsearchavailableto" runat="server" placeholder="Search Employees by keyword"
                ...
                <div class="col-xs-12 form-group pad">
                    <div class="f_left">
                        ...
                        <input type="hidden" id="hidavailid" runat="server" />
                        <input type="hidden" id="hidavailname" runat="server" />
                    </div>
                    <div class="f_left" style="padding: 22px; text-align: center;">
                        <div class="f_left">
                            <input type="button" onclick="move1(this.form.ctl00_ContentPlaceHolder1_listavailcode1, this.form.ctl00_ContentPlaceHolder1_listavailcode2)"
                                class="btn btn-default" style="width: 70px; padding: 2px;" value="Add" id="btnaddavail" />
                        </div>
                        <div class="clear">
                        </div>
                        <div class="f_left padtop10">
    ...
    <script type="text/javascript">
        function searchavailableto() {
            var keyword = $('#ctl00_ContentPlaceHolder1_txtsearchavailableto').val();
        ...
        $('#ctl00_ContentPlaceHolder1_txtsearchavailableto').keypress(function (e) {
            if (e.keyCode == 13) {
                e.preventDefault();
