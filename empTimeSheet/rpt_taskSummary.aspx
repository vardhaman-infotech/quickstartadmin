<%@ Page Title="" Language="C#" MasterPageFile="~/userMaster.Master" AutoEventWireup="true" CodeBehind="rpt_taskSummary.aspx.cs" Inherits="empTimeSheet.rpt_taskSummary" %>
                    ...
                    <div class="col-sm-12 col-md-10">
                        <div style="padding-top: 10px;">
                            <div class="col-xs-12 col-sm-8 col-md-6 f_left" style="padding: 0px;">
                                <h5 class="subtitle mb5" ><asp:Label ID="lblReportName" runat="server" Text="Task Summary Report"></asp:Label> </h5>
                            </div>
                             <div class="clear"></div>
                            <div class="ctrlGroup">
                           ...
                           <div class="ctrlGroup">
                             ...
                             <div class="linkadvancesearch"><a onclick="  $('.divadvancesearch').toggle(300);">Advance search?</a>
                            </div>
