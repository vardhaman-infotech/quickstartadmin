...
{
    public partial class rpt_ExpensesByItem : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (!objda.checkUserInroles("58") && !objda.checkUserInroles("88"))
                {
        ...
        private void f_ReportLoad()
        {
            try
            {
                ...
                ReportViewer1.LocalReport.ReportPath = p + "\\client\\rpt_ExpensesByItem.rdlc";
