...
{
    public partial class rpt_InvoiceRegisterwithCosts : System.Web.UI.Page
    {
        ...
        private void f_ReportLoad()
        {
            try
            {
                ...
                ReportViewer1.LocalReport.ReportPath = p + "\\billing\\invoiceregisterwithcost.rdlc";
                ...
                ReportViewer1.LocalReport.DisplayName = "Invoice Register with Costs";
            }
            catch (Exception ex)
            {
            }
