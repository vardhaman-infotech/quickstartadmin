<%@ Page Title="" Language="C#" MasterPageFile="~/userMaster.Master" AutoEventWireup="true" CodeBehind="ServerBackUpReport.aspx.cs" Inherits="empTimeSheet.ServerBackUpReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="pageheader">
        <h2>
             <i class="fa fa-desktop"></i>Server Backup Report
        </h2>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <asp:GridView ID="dgnews" runat="server" AllowPaging="true" AutoGenerateColumns="false"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Backup Summary">
                                                    <ItemTemplate>
