<%@ Page Title="" Language="C#" MasterPageFile="~/userMaster.Master" AutoEventWireup="true" CodeBehind="AdminDashboard.aspx.cs" Inherits="empTimeSheet.AdminDashboard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="row">
            <div class="col-lg-4 col-sm-12 col-xs-12">
                <div class="whitebox">
                    ...
                    <div class="panel-body">
                        <div id="loadertopemp" class="chartloader">
                            <img src="images/loading.gif" />
                        </div>
                        <div id="charttopEmp" class="chartdiv" style="height: 250px;"></div>
            ...
            <div class="col-lg-4 col-sm-12 col-xs-12">
                <div class="whitebox">
                    ...
                    <div class="panel-body">
                        <div id="loadertopexp" class="chartloader">
                            <img src="images/loading.gif" />
                        </div>
                        <div id="charttopexp" class="chartdiv" style="height: 250px;"></div>
                    ...
                    <div class="shortcut-body">
                        <ul class="list-unstyled">
                            ...
                            <li class="media">
                                ...
                                <div class="media-body">
                                    <a href="ManageEmployee.aspx">Employee Management</a>
                                </div>
                            </li>
                            ...
                            <li class="media">
                                ...
                                <div class="media-body">
                                    <a href="InvoiceReview.aspx">Billing</a>
                                </div>
                            </li>
            ...
            <div class="col-lg-6 col-sm-12 col-xs-12">
                <div class="whitebox">
                    ...
                    <div class="panel-body">
                        ...
                        <div id="charttopact" class="chartdiv" style="height: 250px;"></div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-4 col-sm-12 col-xs-12">
                <div class="whitebox">
                    ...
                    <div class="panel-body">
                        <div id="loaderMonthBilling" class="chartloader">
                            <img src="images/loading.gif" />
                        </div>
                        <div id="chartMonthBilling" class="chartdiv" style="height: 250px;"></div>
            ...
            <div class="col-lg-8 col-sm-12 col-xs-12">
                <div class="whitebox">
                    ...
                    <div class="panel-body">
                        <div class="order-short-info" id="divinvsummary">
                        </div>
                        <hr />
                        <div class="table-responsive" style="height: 365px; overflow: auto;">
                            <table class="table table-hover latest-order" id="tblinvoices">
                                <thead>
                                    <tr>
                                        <th>Date</th>
                            ...
                            <div id="divinvdataloader" style="text-align: center;">
                                <img src="images/loading.gif" />
                            </div>
                        </div>
                    </div>
    ...
    <script src="js/PageJs/dashboardJs.js"></script>
