<%@ Page Title="" Language="C#" MasterPageFile="~/userMaster.Master" AutoEventWireup="true"
    CodeBehind="Designation.aspx.cs" Inherits="empTimeSheet.Designation" %>
    ...
    <asp:UpdatePanel ID="upadatepanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <div class="pageheader">
                <h2>
                    <i class="fa fa-cube"></i>Manage Designation    
                </h2>
                    ...
                    <div class="tabDetails">
                        <div class="tabContents" style="display: block;">
                              <div class="ctrlGroup searchgroup">
                                        <label class="lbl">Designation :<asp:RequiredFieldValidator ID="req1" runat="server" ControlToValidate="txtname"
                                    ...
                                    <div class="ctrlGroup searchgroup">
                                        <label class="lbl">Designation Info :</label>
                                        <div class="txt w2">
