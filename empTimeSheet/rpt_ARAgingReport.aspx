<%@ Page Title="" Language="C#" MasterPageFile="~/userMaster.Master" AutoEventWireup="true" CodeBehind="rpt_ARAgingReport.aspx.cs" Inherits="empTimeSheet.rpt_ARAgingReport" %>
                    ...
                    <div class="col-sm-12 col-md-10">
                        <div style="padding-top: 10px;">
                            <div class="col-xs-12 col-sm-8 col-md-6 f_left" style="padding: 0px;">
                                <h5 class="subtitle mb5">Aging Report 90 Days</h5>
                            </div>
                            <div class="clear"></div>
                            <div class="ctrlGroup searchgroup">
                                ...
                                <div class="txt w1 mar10">
                                    <asp:DropDownList ID="dropdaterange" runat="server" CssClass="form-control" onchange="showcustomdate(this.id);">
                                        ...
                                        <asp:ListItem Text="As Of" Value="AsOf" Selected="True"></asp:ListItem>
                                        ...
                                        <asp:ListItem Text="Last Year to Date" Value="LastYeartoDate"></asp:ListItem>
                            ...
                            <div class="ctrlGroup searchgroup" id="divtodate" style="display: block">
                                <label class="lbl">
                                    To Date :
                                </label>
