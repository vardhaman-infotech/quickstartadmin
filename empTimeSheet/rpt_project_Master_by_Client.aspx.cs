...
{
    public partial class rpt_project_Master_by_Client : System.Web.UI.Page
    {
        ...
        private void f_ReportLoad()
        {
            try
            {
                ...
                ReportViewer1.LocalReport.ReportPath = p + "\\project\\rpt_project_Master_by_Client.rdlc";
                ...
                ReportDataSource rds1 = new ReportDataSource("DataSet2", ds.Tables[0]);
                this.ReportViewer1.LocalReport.DataSources.Clear();
                this.ReportViewer1.LocalReport.EnableExternalImages = true;
                this.ReportViewer1.LocalReport.DataSources.Add(rds1);
                this.ReportViewer1.LocalReport.SetParameters(param);
                this.ReportViewer1.LocalReport.Refresh();
                ReportViewer1.LocalReport.DisplayName = "Project Master Report";
            }
            catch (Exception ex)
            {
            }
