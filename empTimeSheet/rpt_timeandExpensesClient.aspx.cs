...
{
    public partial class rpt_timeandExpensesClient : System.Web.UI.Page
    {
        ...
        private void f_ReportLoad()
        {
            try
            {
                ...
                ReportViewer1.LocalReport.ReportPath = p + "\\client\\rpt_clientTimeandExpSummary_new.rdlc";
                ...
                param[3] = new ReportParameter("reportfilter", "Date Form " + objts.from + " To " + objts.to, true);
                param[4] = new ReportParameter("Cursymbol", ds.Tables[1].Rows[0]["symbol"].ToString(), true);
                ...
                ReportViewer1.LocalReport.DisplayName = "Time and Expenses Summary by Client";
            }
            catch (Exception ex)
            {
            }
