...
{
    public partial class rpt_ARAgingClientAddressReport : System.Web.UI.Page
    {
        ...
        {
            objts.action = "getagingwithclientAddreport";
            ...
            objts.managerId = dropassign.SelectedValue.ToString();
            objts.invoiceno = txtInvoiceNum.Text.ToString();
            objts.companyId = Session["companyid"].ToString();
        ...
        private void f_ReportLoad()
        {
            try
            {
                ...
                ReportViewer1.LocalReport.ReportPath = p + "\\aging\\agingrclientaddressdlc.rdlc";
                ...
                param[3] = new ReportParameter("datefilter", datefilter, true);
                ...
                ReportViewer1.LocalReport.DisplayName = "Aging with Client Address";
            }
            catch (Exception ex)
            {
            }
