<%@ Page Title="" Language="C#" MasterPageFile="~/userMaster.Master" AutoEventWireup="true" CodeBehind="rpt_timeSummary.aspx.cs" Inherits="empTimeSheet.rpt_timeSummary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="pageheader">
        <h2>
            <i class="fa fa-clipboard"></i>Time & Expense Client Report
        </h2>
                            ...
                            <div class="ctrlGroup searchgroup">
                                <div class="txt w1 mar10">
                                    ...
                                    <asp:Panel ID="panelemployee" runat="server" CssClass="poppanel">
                                        ...
                                        <asp:CheckBoxList ID="dropemployee" runat="server" RepeatLayout="Table" Width="100%"  RepeatDirection="Horizontal" ClientIDMode="Static" onchange="setcontent(this.id,'txtemployee','--All Employee--','employee');"></asp:CheckBoxList>
