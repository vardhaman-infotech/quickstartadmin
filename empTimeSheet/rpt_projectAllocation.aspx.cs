...
{
    public partial class rpt_projectAllocation : System.Web.UI.Page
    {
        ...
        private void f_ReportLoad()
        {
            try
            {
                ...
                objts.action = "allocation";
                objts.companyId = Session["companyid"].ToString();
                ReportViewer1.LocalReport.ReportPath = p + "\\project\\rpt_ProjectActivity.rdlc";
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    ReportViewer1.LocalReport.DisplayName = "Project Allocation";
