...
{
    public partial class rpt_ARAgingSummarywithCredit : System.Web.UI.Page
    {
        ...
        {
            objts.action = "getagingreportsummary";
        ...
        private void f_ReportLoad()
        {
            try
            {
                ...
                ReportViewer1.LocalReport.ReportPath = p + "\\aging\\agingSummarywithCreditrdlc.rdlc";
                ...
                ReportViewer1.LocalReport.DisplayName = "Aging Summary with Credit";
            }
            catch (Exception ex)
            {
            }
