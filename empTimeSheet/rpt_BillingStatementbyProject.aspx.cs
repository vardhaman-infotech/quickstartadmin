...
{
    public partial class rpt_BillingStatementbyProject : System.Web.UI.Page
    {
        DataAccess objda = new DataAccess();
        ClsUser objuser = new ClsUser();
        ClsTimeSheet objts = new ClsTimeSheet();
        GeneralMethod objgen = new GeneralMethod();
        string strreportfileter = "";
        ...
        private void f_ReportLoad()
        {
            try
            {
                ...
                ReportViewer1.LocalReport.ReportPath = p + "\\billing\\invoicebillingstatementbyprojectrdlc.rdlc";
                ...
                ReportViewer1.LocalReport.DisplayName = "Billing Statement By Project";
            }
            catch (Exception ex)
            {
            }
