<%@ Page Title="" Language="C#" MasterPageFile="~/userMaster.Master" AutoEventWireup="true"
    CodeBehind="ClientGroup.aspx.cs" Inherits="empTimeSheet.ClientGroup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="pageheader">
        <h2>
            <i class="fa fa-group"></i>Client Groups
        </h2>
        <div class="breadcrumb-wrapper mar ">
            <asp:LinkButton ID="liaddnew" runat="server" CssClass="right_link" OnClick="liaddnew_Click">
             <i class="fa fa-fw fa-plus topicon"></i> Add New Group</asp:LinkButton>
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <asp:GridView ID="dgnews" runat="server" AllowPaging="true" AutoGenerateColumns="False"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="No. of Clients" SortExpression="numofclients">
                                                            <ItemTemplate>
                                                                <%#DataBinder.Eval(Container.DataItem, "numofclients")%>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
    ...
    <div style="display: none; width: 680px;" id="divaddnew" class="itempopup">
        ...
        <div class="tabContents">
            <div class="col-xs-12 col-sm-12">
                ...
                <div class="ctrlGroup searchgroup">
                    <label class="lbl">
                        Select Client :<asp:CustomValidator ID="CustomValidator1" runat="server" ErrorMessage="*" ValidationGroup="save"
                            CssClass="errmsg" ClientValidationFunction="validate1"></asp:CustomValidator></label>
                    <div class="txt w3" style="margin-bottom: 20px;">
                        <asp:TextBox ID="txtsearchclient" runat="server" placeholder="Search Clients by keyword"
