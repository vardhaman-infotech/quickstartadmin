...
{
    public partial class rpt_AssetByLocation : System.Web.UI.Page
    {
        ...
        private void f_ReportLoad()
        {
            try
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    ReportViewer1.LocalReport.ReportPath = p + "\\Asset\\rpt_AssetByLocation.rdlc";
