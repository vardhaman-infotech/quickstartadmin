...
{
    public partial class rpt_ExpenseReport : System.Web.UI.Page
    {
        ...
        private void f_ReportLoad()
        {
            try
            {
                ...
                ReportViewer1.LocalReport.ReportPath = p + "\\employee\\rpt_EmpExpReport.rdlc";
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    param[5] = new ReportParameter("ImgPath", "file:\\" + imagepath, true);
                    ...
                    ReportViewer1.LocalReport.DisplayName = "Employee Expenses Report";
