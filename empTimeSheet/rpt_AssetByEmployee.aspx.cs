...
{
    public partial class rpt_AssetByEmployee : System.Web.UI.Page
    {
        ...
        private void f_ReportLoad()
        {
            try
            {
                ...
                objAsset.locationId = getchkval(dropEmployee);
                objAsset.action = "selectEmp";
                ds = objAsset.ReportAsset();
                if (ds.Tables[0].Rows.Count > 0)
                {
                    divnodata.Visible = false;
                    divreport.Visible = true;
                    ReportViewer1.LocalReport.ReportPath = p + "\\Asset\\rpt_AssetByEmployee.rdlc";
                    ...
                    ReportViewer1.LocalReport.DisplayName = "Asset Report By Employee";
                    divreport.Visible = true;
                    divnodata.Visible = false;
                }
                else
