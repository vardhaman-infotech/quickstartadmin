...
{
    public partial class rpt_ExpenseCodeMaster : System.Web.UI.Page
    {
        ...
        private void f_ReportLoad()
        {
            try
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    ReportViewer1.LocalReport.ReportPath = p + "\\task\\ExpenseList.rdlc";
                    ...
                    ReportViewer1.LocalReport.DisplayName = "Expenses Code Master File";
                    divreport.Visible = true;
                    divnodata.Visible = false;
                }
                else
