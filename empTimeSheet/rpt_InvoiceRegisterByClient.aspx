<%@ Page Title="" Language="C#" MasterPageFile="~/userMaster.Master" AutoEventWireup="true" CodeBehind="rpt_InvoiceRegisterByClient.aspx.cs" Inherits="empTimeSheet.rpt_InvoiceRegisterByClient" %>
                    ...
                    <div class="col-sm-12 col-md-10">
                        <div style="padding-top: 10px;">
                            <div class="col-xs-12 col-sm-8 col-md-6 f_left" style="padding: 0px;">
                                <h5 class="subtitle mb5">
                                    <asp:Label ID="lblReportName" runat="server" Text="Invoice Register Report"></asp:Label>
                                </h5>
                            </div>
                            <div class="clear"></div>
                        ...
                        <div class="clear"></div>
                           ...
                           <div class="ctrlGroup searchgroup">
                               ...
                               <div class="txt w1 mar10">
                                <asp:TextBox ID="txtinvno" runat="server" CssClass="form-control" placeholder="Search by Invoice No."></asp:TextBox>
                            </div>
                               </div>
