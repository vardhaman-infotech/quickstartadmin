...
{
    public partial class rpt_BillingPercentageBilled : System.Web.UI.Page
    {
        ...
        {
            objts.action = "billingpercentage";
            objts.type = "";
            objts.Status = "";
            ...
            objts.type = dropcontracttype.Text;
            objts.invoiceno = "";
        ...
        private void f_ReportLoad()
        {
            try
            {
                ...
                ReportViewer1.LocalReport.ReportPath = p + "\\billing\\invoicepercentagebilled.rdlc";
                ...
                ReportViewer1.LocalReport.DisplayName = "Percentage Billed";
            }
            catch (Exception ex)
            {
            }
