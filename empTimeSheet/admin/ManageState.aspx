<%@ Page Title="" Language="C#" MasterPageFile="~/admin/defaultMaster.Master" AutoEventWireup="true"
    CodeBehind="ManageState.aspx.cs" Inherits="emptimesheet.admin.ManageState" %>
                ...
                <div style="width: 99%; padding-left: 10px; padding-top: 15px;">
                    <table width="98%" align="center" border="0" cellpadding="0" cellspacing="0">
                        <tr style="height: 30px;">
                            ...
                            <td>
                                <asp:DropDownList ID="ddlcountry" runat="server" class="smallInput dropsmall">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr style="height: 30px;">
                            <td width="120" id="tdstate" class="tdcol1">
                                State Name
                            </td>
                            <td>
