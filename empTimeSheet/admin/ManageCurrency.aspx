<%@ Page Title="" Language="C#" MasterPageFile="~/admin/defaultMaster.Master" AutoEventWireup="true" CodeBehind="ManageCurrency.aspx.cs" Inherits="emptimesheet.admin.ManageCurrency" %>
...
<script type="text/javascript" language="javascript">
    ...
    function checkfield() {
        ...
        if (document.getElementById("<%=txtdescription.ClientID %>").value == "") {
            document.getElementById("tdsymbol").className = "tdcolerror";
            flag = 1;
        }
        else {
            document.getElementById("tdsymbol").className = "tdcol1";
        }
        if (flag == 1) {
            return false;
        }
            ...
            <div style="display: none; width: 450px;" id="divaddnew" class="newpopupdiv">
                ...
                <div style="width: 99%; padding-left: 10px; padding-top: 15px;">
                    <table width="98%" align="center" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr style="height: 30px;">
                            <td id="tdsymbol" class="tdcol1">
                                Symbol
                            </td>
                            <td>
                                <textarea id="txtdescription" runat="server" rows="5" cols="25" class="smallInput txtsmall"
                            ...
                            <div class="divgrid" id="divgrid" runat="server">
                                <asp:DataGrid ID="dgnews" runat="server" AllowPaging="True" PagerStyle-Font-Size="15px"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateColumn HeaderText="Currency Name">
                                            <ItemTemplate>
