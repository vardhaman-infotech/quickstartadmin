...
namespace emptimesheet.admin
{
    public partial class ManageCurrency : System.Web.UI.Page
    {
        ...
        protected void btnsave_Click(object sender, EventArgs e)
        {
            ...
            objda.symbol = txtdescription.Value;
            objda.action = "checkcurrencyexists";
            ...
            if (ds != null)
            {
                if (ds.Tables[0].Rows.Count > 0)
                {
                    if (ds.Tables[0].Rows[0][0].ToString() == "0")
                    {
                        ...
                        txtName.Focus();
                        ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "temp", "<script type='text/javascript'>alert('Currency already exists!');</script>", false);
        ...
        protected void dgnews_ItemCommand1(object source, DataGridCommandEventArgs e)
        {
            ...
            if (e.CommandName == "edit")
            {
                ...
                txtdescription.Value = ds.Tables[0].Rows[0]["symbol"].ToString();


                txtName.Value = ds.Tables[0].Rows[0]["currencyName"].ToString();
