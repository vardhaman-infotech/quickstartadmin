<%@ Page Title="" Language="C#" MasterPageFile="~/userMaster.Master" AutoEventWireup="true"
    CodeBehind="ProjectAllocation.aspx.cs" Inherits="empTimeSheet.ProjectAllocation" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajax" %>
<%@ Register Src="progressbar.ascx" TagName="progress" TagPrefix="pg" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style type="text/css">
        .rootnode{margin-top:0px;}
        .rootselected{
             background:#11A18C;
        }
        .rootselected a{
    ...
    <script type="text/javascript">
        ...
        ({
            ...
            type: "POST",
            url: "ProjectAllocation.aspx/savestatus",
            ...
            if (type == "A") {
                ...
                if (confirm('do you want to release this task?')) {
                    ...
                    $.ajax({
                        ...
                        type: "POST",
                        url: "ProjectAllocation.aspx/release_task",
                        data: JSON.stringify(args),
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        async: true,
        ...
        function saveAssign() {
            ...
            if (status == 0 || document.getElementById("assig_hid_nid").value == "") {
                ...
                $.ajax({
                    ...
                    type: "POST",
                    url: "ProjectAllocation.aspx/assign_task",
                    data: JSON.stringify(args),
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    async: true,
                    ...
                    success: function (msg) {
                        ...
                        if (msg.d != "failure") {
                            ...
                            document.getElementById(divid).innerHTML = "Assigned to <b>" + arr[0] + "</b>";
                            document.getElementById(linkid).innerHTML = "Assign";
        ...
        <ContentTemplate>
                                        ...
                                        <asp:Repeater ID="rptinner" runat="server" OnItemCommand="rptinner_OnItemCommand"
                                            ...
                                            <ItemTemplate>
                                                <div class="detailbox_label">
                                                    <div class="f_left">
                                                        <div class="taskcode"><div class="taskcode-inner"><%#Eval("taskcodename")%> : <%#Eval("task")%></div> </div>
                                                    </div>
                                                    <div class="f_right">
                                                        <span id="litassignto" runat="server"></span>&nbsp; &nbsp; (<a id="linkassign" runat="server">
                                                            Assign</a>)
                                                    </div>
                                                    <input type="hidden" id="hidallempid" runat="server" value='<%#Eval("allempid")%>' />
                                                </div>
                                                <div class="clear">
                                                </div>
                                                <div class="detailbox">
            ...
            <div id="divaddallocation" class="itempopup" style="width: 550px;">
                ...
                <div class="popup_heading">
                    <span id="Span1" runat="server">Assign task to an employee</span>
                    <div class="f_right">
