...
{
    public partial class rpt_ARAgingReport : System.Web.UI.Page
    {
        ...
        private void f_ReportLoad()
        {
            try
            {
             ...
             // ReportViewer1.LocalReport.ReportPath = p + "\\aging\\agingrdlc.rdlc";
                ...
                ReportDataSource rds1 = new ReportDataSource("DataSet1", ds.Tables[0].Copy());
                ds.Dispose();
                GC.Collect();
                ...
                ReportViewer1.LocalReport.DisplayName = "AR Aging Report";
            }
            catch (Exception ex)
            {
            }
