<%@ Page Title="" Language="C#" MasterPageFile="~/userMaster.Master" AutoEventWireup="true" CodeBehind="rpt_MonthlyBillingSummaryByClient.aspx.cs" Inherits="empTimeSheet.rpt_MonthlyBillingSummaryByClient" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="pageheader">
        <h2>
            <i class="fa fa-clipboard"></i>Monthly Billing Summary by Client
        </h2>
                        ...
                        <div style="padding-top: 10px;">
                            <div class="col-xs-12 col-sm-8 col-md-6 f_left" style="padding: 0px;">
                                <h5 class="subtitle mb5">
                                    <asp:Label ID="lblReportName" runat="server" Text="Monthly Billing Summary by Client"></asp:Label>
                                </h5>
                            </div>
                            ...
                            <asp:UpdatePanel ID="updateclientmst" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <div class="ctrlGroup searchgroup">
