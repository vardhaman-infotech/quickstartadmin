<%@ Page Title="" Language="C#" MasterPageFile="~/userMaster.Master" AutoEventWireup="true" CodeBehind="rpt_Analysis_HoursComparebyEmp.aspx.cs" Inherits="empTimeSheet.rpt_Analysis_HoursComparebyEmp" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="pageheader">
        <h2>
            <i class="fa fa-clipboard"></i>Analysis Report
        </h2>
                        ...
                        <div style="padding-top: 10px;">
                            <div class="col-xs-12 col-sm-8 col-md-6 f_left" style="padding: 0px;">
                                <h5 class="subtitle mb5">
                                    <asp:Label ID="lblReportName" runat="server" Text="A-Hours B-Hours Comparison by Employee"></asp:Label>
                                </h5>
                            </div>
                            ...
                            <div class="ctrlGroup searchgroup">
                                <label class="lbl lbl2 disNone">
                                    &nbsp;
                                </label>
                                <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional" class="txt w1">
                                    <ContentTemplate>
