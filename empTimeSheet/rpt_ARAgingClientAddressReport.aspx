<%@ Page Title="" Language="C#" MasterPageFile="~/userMaster.Master" AutoEventWireup="true" CodeBehind="rpt_ARAgingClientAddressReport.aspx.cs" Inherits="empTimeSheet.rpt_ARAgingClientAddressReport" %>
                    ...
                    <div class="col-sm-12 col-md-10">
                        <div style="padding-top: 10px;">
                            <div class="col-xs-12 col-sm-8 col-md-6 f_left" style="padding: 0px;">
                                <h5 class="subtitle mb5">AR Aging Report With Client Address</h5>
                            </div>
                            ...
                            <div class="ctrlGroup searchgroup">
                                ...
                                <div class="txt w1 mar10">
                                    ...
                                    <asp:DropDownList ID="dropassign" runat="server" CssClass="form-control pad3">
                                    </asp:DropDownList>
                            ...
                            <div class="ctrlGroup searchgroup">
                                ...
                                <div class="txt w2 ">
                                    <div class="txt w1">
                                        <asp:TextBox ID="txtInvoiceNum" runat="server" CssClass="form-control  pad3" ClientIDMode="Static" placeholder="Invoice Number">
                                        </asp:TextBox>
                                    </div>
                                </div>
                            </div>
